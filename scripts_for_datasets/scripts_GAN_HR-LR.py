...
def generate_mod_LR_bic():
    ...
    sourcedir = (
        "/Users/vedaad/caliber/EESRGAN/data/DetectionPatches_256x256/Potsdam_ISPRS"
    )
    savedir = (
        "/Users/vedaad/caliber/EESRGAN/data/DetectionPatches_256x256/Potsdam_ISPRS"
    )
    ...
    filepaths = [
        ...
        if f.endswith(".jpg") and not f.endswith("check.jpg")
    ]
...
def merge_edge():
    ...
    for i, j, k in zip(img_SR, img_lap, img_lap_learned):
        ...
        img_path = os.path.join(
            folder_name, file_name + "_216000_img_final_SR_enhanced.png"
        )
...
def calculate_psnr_ssim():
    ...
    for (
        ...
        print(
            ...
            os.path.basename(im_SR_combined) + "--",
