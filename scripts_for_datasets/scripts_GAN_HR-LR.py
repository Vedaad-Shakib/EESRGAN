...
def generate_mod_LR_bic():
    ...
    sourcedir = '/Users/vedaad/caliber/EESRGAN/data/DetectionPatches_256x256/Potsdam_ISPRS'
    savedir = '/Users/vedaad/caliber/EESRGAN/data/DetectionPatches_256x256/Potsdam_ISPRS'
