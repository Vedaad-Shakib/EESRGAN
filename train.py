...
def main(config):
    ...
    valid_data_loader = module_data.COWCGANFrcnnDataLoader('/Users/vedaad/caliber/EESRGAN/data/DetectionPatches_256x256/Potsdam_ISPRS/HR/x4/valid_img/',
    '/Users/vedaad/caliber/EESRGAN/data/DetectionPatches_256x256/Potsdam_ISPRS/HR/x4/valid_img/', 1, training = False)
